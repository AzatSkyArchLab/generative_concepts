/**
 * MeshBuilder — cell bricks + internal divider walls between sections
 *
 * buildDividerWall: thin dark wall between adjacent sections,
 *   extends 0.05m above section top. No walls at outer ends.
 */
...
// ── Divider wall (between adjacent sections only) ──────

/**
 * Thin dark wall between two adjacent sections.
 * p1, p2: two endpoints of the shared boundary edge (in meters).
 * topZ includes +0.05 overshoot above section.
 *
 * @param {Array} p1 - [mx, my]
 * @param {Array} p2 - [mx, my]
 * @param {number} baseZ
 * @param {number} topZ - should be sectionTop + 0.05
